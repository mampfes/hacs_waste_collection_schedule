...
- Once you have found your street on the website, hover over the yellow "Calendar - add to calendar (iCalendar)" button, right click and copy link, you should get back a URL e.g. https://wellington.govt.nz/~/ical/?type=recycling&streetId=6272&forDate=2026-05-03
- Look for the streetId parameter in the URL in the example link above, it is streetId=`6272`
