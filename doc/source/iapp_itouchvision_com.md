...
## Buckinghamshire note
Buckinghamshire (including the former Aylesbury Vale, Chiltern, South Bucks and Wycombe districts) moved its bin collection lookup to the iTouchVision "My Council Services" portal in August 2026. Configuration is unchanged, but the portal only publishes the *next* collection of each waste type, so fewer future dates are available than for the other municipalities.
