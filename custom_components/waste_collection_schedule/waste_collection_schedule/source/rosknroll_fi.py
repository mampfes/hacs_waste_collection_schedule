...
TITLE = "RosknRoll Finland"
DESCRIPTION = "Schedule for RosknRoll FI"
URL = "https://www.rosknroll.fi"
TEST_CASES = {
    "Test1": {
        "bill_number": "!secret rosknroll_fi_bill_number",
        "password": "!secret rosknroll_fi_bill_password",
    }
}
ICON_MAP = {
    "SE": Icons.GENERAL_WASTE,
