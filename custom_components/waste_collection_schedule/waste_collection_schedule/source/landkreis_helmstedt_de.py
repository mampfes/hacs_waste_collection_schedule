...
from waste_collection_schedule.exceptions import SourceArgumentNotFoundWithSuggestions, SourceArgumentException
...
TEST_CASES = {
    "Grasleben": {"municipal": "Grasleben und Velpke", "restabfall": 1, "bioabfall": 1, "gelber_sack": 3, "altpapier": 5},
    "Paläon": {"municipal": "Schöningen und Heeseberg", "restabfall": 1, "bioabfall": 1, "gelber_sack": 1, "altpapier": 2},
    "Rhode": {"municipal": "Nord-Elm und Königslutter Ortsteile", "restabfall": 2, "bioabfall": 2, "gelber_sack": 1, "altpapier": 2},
    "Essehof": {"municipal": "Lehre", "restabfall": 1, "bioabfall": 1, "gelber_sack": 2, "altpapier": 1},
    "Braunschweiger Str.": {"municipal": "Königslutter Stadtgebiet", "restabfall": 1, "bioabfall": 1, "gelber_sack": 1, "altpapier": 1},
    "Barmke": {"municipal": "Helmstedt und Ortsteile", "restabfall": 3, "bioabfall": 3, "gelber_sack": 3, "altpapier": 5},
}
...
HOW_TO_GET_ARGUMENTS_DESCRIPTION = { # Optional dictionary to describe how to get the arguments, will be shown in the GUI configuration form above the input fields, does not need to be translated in all languages
    "en": "Visit " + API_URL + " and first get the name of the ICS calendar on the website for your municipal, then open the related PDF calender and find the collection areas.",
    "de": "Öffne " + API_URL + " und finde den Name des ICS Kalenders deiner Gemeinde heraus. Öffne danach den PDF Kalender und suche die passenden Abholgebiete.",
}
...
class Source:
    def __init__(self, municipal: str, restabfall: int, altpapier: int, gelber_sack: int, bioabfall: int):
    ...
    def fetch(self):
        ...
        if not foundMunicipalCalendarICSDownloadURL:
            raise SourceArgumentException(argument="municipal", message="No Abholgebiet found for " + self._municipal + ". Please check " + API_URL + " for correct ICS calendar name.")
