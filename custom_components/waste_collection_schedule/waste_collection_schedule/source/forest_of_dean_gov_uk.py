...
DESCRIPTION = "Source for Forest of Dean District Council, UK."
URL = "https://www.fdean.gov.uk/"
COUNTRY = "uk"
TEST_CASES = {
    "Southfield Road, Coleford": {"address": "8 SOUTHFIELD ROAD, COLEFORD, GL16 8BZ"},
    "Wynols Close, Broadwell": {
        "address": "36 WYNOLS CLOSE, BROADWELL, COLEFORD, GL16 7RR"
    },
}

HOW_TO_GET_ARGUMENTS_DESCRIPTION = {
    "en": (
        "Go to the Forest of Dean waste collection enquiry page and type your "
        "postcode into the address lookup. Use the full address string exactly "
        "as it is returned by the autocomplete (e.g. "
        "'8 SOUTHFIELD ROAD, COLEFORD, GL16 8BZ')."
    ),
}
...
PARAM_DESCRIPTIONS = {
    "en": {
        "address": (
            "The full address string as returned by the lookup on the waste "
            "collection enquiry page."
        ),
    },
}
