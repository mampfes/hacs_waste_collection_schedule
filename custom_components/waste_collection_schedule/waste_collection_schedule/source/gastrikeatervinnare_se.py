...
ICON_MAP = {"Restavfall": "mdi:trash-can", "Matavfall": "mdi:leaf", "Blandat": "mdi:trash-can"}
...
class Source:
    ...
    def get_date(self, waste_type_info):
        pickup_date = waste_type_info.find(
            "div", attrs={"class": "pickup-time"}
        ).find_all("span")[1].text.split(" ")[1]
