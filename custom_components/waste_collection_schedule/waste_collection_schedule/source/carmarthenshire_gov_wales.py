...
HOW_TO_GET_ARGUMENTS_DESCRIPTION = { # Optional dictionary to describe how to get the arguments, will be shown in the GUI configuration form above the input fields, does not need to be translated in all languages
    "en": "You can find your UPRN by visitng https://www.findmyaddress.co.uk/ and entering in your address details.",
}
...
class Source:
    ...
    def fetch(self) -> list[Collection]:
        ...
        s = requests.Session()
        response = s.get(f"https://www.carmarthenshire.gov.wales/umbraco/Surface/SurfaceRecycling/Index/?uprn={self._uprn}&lang=en-GB")
        ...
        for item in containers:
            ...
            entries.append(
                Collection(
                    ...
                    # date = datetime.date(dates[0].text.split("  ")[1].strip()),
