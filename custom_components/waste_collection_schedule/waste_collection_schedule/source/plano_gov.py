...
class Source:
    ...
    def fetch(self) -> list[Collection]:
        ...
        # recycling
        ttype = "RECYCLE"
        # recycling is returned with a similar curr, next1, next2 format like bulky
        # however, it actually returns 2-3 dates in the curr depending on how many recycling occurrences there will be
