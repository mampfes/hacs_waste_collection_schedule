...
ICON_MAP = {  # Map collection names to icons
...
# Map collection names to type of trash
collections_map = {
    ...
    def fetch(self) -> list[Collection]:
        ...
        for month_table in soup.select("#mainKalender table"):
            ...
            for day_cell in month_table.find_all("td"):
                ...
                if span:
                    trash_type = span.get_text(strip=True)
        ...
        for entry in unique_data:
            ...
            collection_date = datetime(year=year, month=month_number, day=day)
