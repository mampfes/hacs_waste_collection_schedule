    ...
    def __call__(self, source: "BaseSource"):
        ...
        if r.status_code == 401:
            raise ValueError(
                ...
                "Please switch to the 'Abfall.IO / AbfallPlus (GraphQL)' source "
                "(abfall_io_graphql) instead, which supports the v3 API. See "
                "https://github.com/mampfes/hacs_waste_collection_schedule/blob/master/doc/source/abfall_io_graphql.md"
            )
        r.raise_for_status()
