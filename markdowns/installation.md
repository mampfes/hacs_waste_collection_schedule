...
5. Click on `Download` to copy the relevant files to you `config/custom_components/` directory.
6. [Configure your waste collection source(s)](#configuration).
7. [Configure your waste collection sensor(s)](#configuration).
